...
const carValueController = __importStar(require("../controllers/carValueController"));
...
router.get("/carValues/:id/calculate", carValueController.calculateCarValueById);
router.post("/carValue", carValueController.calculateCarValue);
// Add new endpoint for calculateCarValueIgnoringNumbers
router.post("/calculateCarValueIgnoringNumbers", carValueController.calculateCarValueIgnoringNumbers);
